CREATE DATABASE bddVariedadesMansStyle

USE bddVariedadesMansStyle
...
('Variedades Mans Style', 'Las Américas #2 frente al parque del grupo A, camino hacia la terminal de la 114 y 170', 1);
...
VALUES 
(1, 'Kleyber Parrales', '001-K', 30, 'AdminKleyber' , '123', 1, 1),
(0, 'Ares Stanley', '001-A', 25, 'VendedorAres' , '321', 2, 1);
...
VALUES (1, 'Camiseta', 'Marca A', 50,								10.00, 20.00, 1, 'Camiseta de algodón, talla M', 1), 
(2, 'Perfume', 'Marca B', 30,										25.00, 50.00, 2, 'Fragancia floral, 50ml', 1), 
(3, 'Auriculares', 'Marca C', 20,									15.00, 30.00, 1, 'Auriculares con cancelación de ruido', 1), 
(1, 'Pantalones', 'Marca D', 40,									20.00, 40.00, 2, 'Pantalones de mezclilla, talla L', 1), 
(2, 'Labial', 'Marca E', 60,										5.00, 15.00, 1, 'Labial rojo, larga duración', 1), 
(3, 'Cargador', 'Marca F', 70,										8.00, 20.00, 2, 'Cargador rápido, 2A', 1), 
(1, 'Zapatos', 'Marca G', 35,										30.00, 60.00, 1, 'Zapatos de cuero, talla 42', 1), 
(2, 'Crema', 'Marca H', 45,											10.00, 25.00, 2, 'Crema hidratante, 100ml', 1), 
(3, 'Mouse', 'Marca I', 25,											12.00, 25.00, 1, 'Mouse ergonómico, inalámbrico', 1), 
(1, 'Chaqueta', 'Marca J', 15,										50.00, 100.00, 2, 'Chaqueta impermeable, talla XL', 1);


-- Creación de la tabla Compra_Entrada (relación muchos a muchos entre Proveedor y Producto)
...
-- Creación de la tabla Venta_Factura (relación muchos a muchos entre Cliente y Producto)
